...
export function useJogoDoGalo() {
    ...
    function adicionarJogada(jogo, jogador, linha, coluna) {
        ...
        setState(ps => {
            ...
            const novoJogo = {
                ...
                jogadorAtual: jogo.jogadorAtual === "Brasileiro" ? "Português" : "Brasileiro", // alterna o jogador atual
            };
    ...
    function verificarVencedor(jogo) {
        ...
        if (sequencias.includes("BrasileiroBrasileiroBrasileiro")) return "Brasileiro"
        if (sequencias.includes("PortuguêsPortuguêsPortuguês")) return "Português"
        return undefined
    }
